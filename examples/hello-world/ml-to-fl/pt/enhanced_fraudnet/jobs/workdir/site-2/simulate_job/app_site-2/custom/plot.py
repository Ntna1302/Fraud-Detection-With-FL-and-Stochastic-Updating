...
def plot_confusion_matrices(model, test_loader, threshold=0.9, save_path="./confusion_matrices.png", device='cuda', apply_mask=False):
    """
    ...
    y_test_tensor = torch.cat(y_test, dim=0).cuda()
    ...
    with torch.no_grad():
        ...
        for features, targets in test_loader:
            ...
            y_pred_numpy.extend(predictions)
    print(y_pred_numpy[10:30])
    print(y_test_numpy[10:30])
    # Compute confusion matrix
    print(len(y_test_numpy), len(y_pred_numpy))
