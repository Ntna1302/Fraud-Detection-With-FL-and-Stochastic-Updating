...
df = pd.read_csv('/home/nahear/Thesis/NVFlare/examples/hello-world/ml-to-fl/pt/src/data/creditcard.csv')
...
# Save to CSV files
site1_df.to_csv('/home/nahear/Thesis/NVFlare/examples/hello-world/ml-to-fl/pt/src/data/site1.csv', index=False)
site2_df.to_csv('/home/nahear/Thesis/NVFlare/examples/hello-world/ml-to-fl/pt/src/data/site2.csv', index=False)
server_df.to_csv('/home/nahear/Thesis/NVFlare/examples/hello-world/ml-to-fl/pt/src/data/server.csv', index=False)

combine_df = pd.concat([site1_df, site2_df])
combine_df.to_csv('/home/nahear/Thesis/NVFlare/examples/hello-world/ml-to-fl/pt/src/data/train_valid.csv', index=False)
