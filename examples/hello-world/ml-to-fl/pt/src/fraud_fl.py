...
BASE_PATH = "/home/nahear/Thesis/NVFlare/examples/hello-world/ml-to-fl/pt/src/data"
...
def main():
    # set_all_seeds(44)  # Comment out this so that it is pure randomness when training.
    epochs = 15
    save_plot_dir = 'plot'
    ...
    train_loader, valid_loader, test_loader, class_weights, _ = get_dataloaders_fraud(
    ...
    while flare.is_running():
        ...
        train_loss_list, train_metrics_list, valid_metrics_list, test_metrics = train_model(
            ...
            scheduler=scheduler, stochastic=True,
        )
