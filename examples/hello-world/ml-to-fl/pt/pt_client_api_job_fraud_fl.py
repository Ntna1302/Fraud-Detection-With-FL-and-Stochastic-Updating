...
from src.net import Net, FraudNet, EnhancedFraudNet
...
def main():
    ...
    job = FedAvgJob(
        ...
        initial_model=EnhancedFraudNet(),
    )
    ...
    if export_config:
        job.export_job("./enhanced_fraudnet_stochastic/jobs/job_config")
    else:
        job.simulator_run("./enhanced_fraudnet_stochastic/jobs/workdir", gpu="0")
